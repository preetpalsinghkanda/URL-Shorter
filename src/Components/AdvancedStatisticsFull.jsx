...
const AdvancedStatisticsFull = () => {
  return (
    <div className="pt-55 mt-10 pb-30 w-full items-center flex justify-center bg-[#EFF1F7]">
    <div className=" min-w-6xl max-w-6xl flex gap-30 flex-col items-center ">
      <div className="text-center flex gap-4 flex-col">
        <h2 className="text-4xl font-[700] text-[#232127]">Advanced Statistics</h2>
        <p className="text-xl font-[500] text-[#9e9aa7]">
          Track how your links are performing across the web with{" "}
          <p className="block"></p> our advanced statistics dashboard.
        </p>
      </div>

      <div className="relative flex gap-8 h-95 items-start">
        <hr className="absolute top-1/2 left-0 w-full border-5 border-cyan-400" />
